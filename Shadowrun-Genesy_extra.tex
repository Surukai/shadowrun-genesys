...
%	\begin{center}
%	\includegraphics[width=1.0\linewidth]{"images/SR5_Gun Battle"}
%	\end{center}
%	\caption{Gun battle}
%\end{wrapfigure}
\begin{figure}[h]
...
\chapter{New Spells and effects}
...
\begin{multicols}{2}
\section{Tier 1}
\Talent{Rapid shift}{1}{Maneuver}{No} Can use the Shift power once per encounter as a Maneuver instead of Action.

\Talent{Metahuman education}{1}{Passive}{Yes} When this talent is selected select 1 career skill. That skill no longer suffer the penalty from \textit{Uneducated} and now cost like a normal career skill to improve. Additional ranks in this talent adds two more career skills to be selected.
