...
\begin{multicols}{2}
	...
	\subsection{Seven-7}
	Target must make an immediate Daunting (\DifficultyDie[4]) Resillience check or suffer 10 wounds and become \textit{Staggered} for 3 rounds. \Advantage\ can be used to reduce the damage and duration of the stagger and replace with with Disorientation instead. 
