...
\begin{description}
	...
	\item[Vulnerability: Silver] Shapeshifters are vulnerable to silver and cannot regenerate wounds or strain caused by silver weapons. See the weapon entry on \ref{silver} for more information.
...
\subsection{Cyberware, augmentation, and talent stacking}
...
\Talent{Enduring}{4}{Passive}{No} Enduring increases your character's soak by 1. You can only select this talent if you have Essence of 6.
